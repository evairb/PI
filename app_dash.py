...
app.layout = html.Div(children=[
    ...
    html.H2(children='Contem apenas estados que contem mata atlântica', id="Explicacao1" ),
...
def teste(value):
    if value == "Todos Estados":
        ...
        tabela_filtrada = df.loc[df['Estado']==value,:].sort_values(by="Area Desmatada(km)", ascending = False )
